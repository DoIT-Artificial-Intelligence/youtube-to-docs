    ...
    with patch("youtube_to_docs.app._run_job", new_callable=AsyncMock):
        resp = client.post(
            ...
            json={
                ...
                "infographic_model": "gemini-3.5-flash-lite-image",
                "alt_text_model": "gemini-3.5-flash-lite",
                "no_youtube_summary": True,
                "translate": "gemini-3.5-flash-lite-es",
                "combine_infographic_audio": True,
                "all_suite": "gemini-flash",
                "suggest_corrected_captions": "gemini-3.5-flash-lite",
