...
class TestParseTranslateArg(unittest.TestCase):
    def test_simple_model_and_lang(self):
        model, lang = parse_translate_arg("gemini-3.5-flash-lite-es")
    ...
    def test_various_languages(self):
        cases = [
            ("gemini-3.5-flash-lite-ja", "gemini-3.5-flash-lite", "ja"),
            ("gemini-3.5-flash-lite-ko", "gemini-3.5-flash-lite", "ko"),
            ("gemini-3.5-flash-lite-zh", "gemini-3.5-flash-lite", "zh"),
            ("gemini-3.5-flash-lite-pt", "gemini-3.5-flash-lite", "pt"),
        ]
    ...
    def test_language_name_spanish(self):
        model, lang = parse_translate_arg("gemini-3.5-flash-lite-spanish")
        self.assertEqual(model, "gemini-3.5-flash-lite")
        self.assertEqual(lang, "es")
    ...
    def test_unknown_language_passed_through(self):
        model, lang = parse_translate_arg("gemini-3.5-flash-lite-xx")
...
class TestTranslateText(unittest.TestCase):
    ...
    def test_calls_query_llm_with_correct_prompt(self, mock_get_provider):
        ...
        provider_instance: Any = MockLLMProvider("gemini-3.5-flash-lite")
        ...
        result, in_tok, out_tok = translate_text(
            "gemini-3.5-flash-lite", "Hello world", "es"
        )
    ...
    def test_target_language_in_prompt(self, mock_get_provider):
        ...
        translate_text("gemini-3.5-flash-lite", "Hello", "fr")
...
class TestProcessTranslate(unittest.TestCase):
    ...
    def _base_row(self, model="gemini-3.5-flash-lite", transcript_arg="youtube"):
        return {
    ...
    def test_translates_secondary_youtube_columns(self, mock_translate):
        mock_translate.return_value = ("traducido", 10, 5)
        model = "gemini-3.5-flash-lite"
        transcript_arg = "gemini-3.5-flash-lite"
        row = self._base_row(model, transcript_arg)
...
class TestParseSuggestCaptionsArg(unittest.TestCase):
    def test_model_only_no_source(self):
        model, source = parse_suggest_captions_arg("gemini-3.5-flash-lite")
        self.assertEqual(model, "gemini-3.5-flash-lite")
        self.assertIsNone(source)

    def test_model_with_youtube_source(self):
        model, source = parse_suggest_captions_arg("gemini-3.5-flash-lite-youtube")
        self.assertEqual(model, "gemini-3.5-flash-lite")
        self.assertEqual(source, "youtube")

    def test_model_with_gcp_source(self):
        model, source = parse_suggest_captions_arg("gemini-3.5-flash-lite-gcp-chirp3")
        self.assertEqual(model, "gemini-3.5-flash-lite")
        self.assertEqual(source, "gcp-chirp3")

    def test_model_with_aws_source(self):
        model, source = parse_suggest_captions_arg(
            "gemini-3.5-flash-lite-aws-transcribe"
        )
        self.assertEqual(model, "gemini-3.5-flash-lite")
    ...
    def test_bedrock_model_with_gemini_source(self):
        model, source = parse_suggest_captions_arg(
            "bedrock-nova-2-lite-v1-gemini-3.5-flash-lite"
        )
        self.assertEqual(model, "bedrock-nova-2-lite-v1")
        self.assertEqual(source, "gemini-3.5-flash-lite")
    ...
    def test_vertex_source(self):
        model, source = parse_suggest_captions_arg(
            "gemini-3.5-flash-lite-vertex-gemini-pro"
        )
        self.assertEqual(model, "gemini-3.5-flash-lite")
