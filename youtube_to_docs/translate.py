...
Usage (CLI)::
    ...
    uv run youtube-to-docs URL -m gemini-3.5-flash-lite \
        -tr gemini-3.5-flash-lite-es
...
def parse_translate_arg(translate_arg: str) -> Tuple[str, str]:
    ...
    Examples:
      "gemini-3.5-flash-lite-es"         -> ("gemini-3.5-flash-lite", "es")
      "gemini-3.5-flash-lite-spanish"    -> ("gemini-3.5-flash-lite", "es")
    ...
    if len(parts) != 2:
        raise ValueError(
            ...
            "Expected '{model}-{language}' e.g. 'gemini-3.5-flash-lite-es', "
            "'gemini-3.5-flash-lite-spanish', 'aws-translate-es', "
            "or 'gcp-translate-es'."
        )
...
def parse_suggest_captions_arg(arg: str) -> Tuple[str, Optional[str]]:
    ...
    (e.g. 'gcp-chirp3', 'gemini-3.5-flash-lite'). Parsing scans
    ...
    Examples:
      ...
      "gemini-3.5-flash-lite-youtube"       -> ("gemini-3.5-flash-lite", "youtube")
      "gemini-3.5-flash-lite-gcp-chirp3"    -> ("gemini-3.5-flash-lite", "gcp-chirp3")
