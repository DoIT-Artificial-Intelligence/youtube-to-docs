...
const pricingData = {
    ...
    "prices": [
        ...
        {"id": "claude-sonnet-4.6", "vendor": "anthropic", "name": "Claude Sonnet 4.6", "input": 3, "output": 15},
        ...
        {"id": "gemini-3-pro-image", "vendor": "google", "name": "Gemini 3 Pro Image Preview", "input": 2.0, "output": 120.0},
        {"id": "gemini-3.1-flash-image", "vendor": "google", "name": "Gemini 3.1 Flash Image Preview*", "input": 30.0, "output": 30.0},
