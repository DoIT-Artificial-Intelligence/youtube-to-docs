...
const pricingData = {
    ...
    "prices": [
        ...
        {"id": "claude-opus-4.7", "vendor": "anthropic", "name": "Claude Opus 4.7 \u2264200k", "input": 5, "output": 25},
        {"id": "claude-opus-4.7-200k", "vendor": "anthropic", "name": "Claude Opus 4.7 >200k", "input": 10, "output": 37.5},
