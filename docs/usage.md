...
```bash
youtube-to-docs atmGAHYpf_c -m gemini-3.1-flash-lite --tts gemini-3.1-flash-tts-preview-Kore --infographic gemini-3.1-flash-image --combine-infographic-audio
```
...
```bash
youtube-to-docs atmGAHYpf_c -m gemini-3.1-flash-lite -tr gemini-3.1-flash-lite-es --tts gemini-3.1-flash-tts-preview-Kore --infographic gemini-3.1-flash-image --combine-infographic-audio
```
