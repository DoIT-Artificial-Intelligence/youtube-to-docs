...
```bash
youtube-to-docs @mga-othercommittees6625 -m vertex-claude-haiku-4-5@20251001 --tts gemini-3.1-flash-tts-preview-Kore --infographic gemini-3.1-flash-image-preview
```
...
```bash
youtube-to-docs atmGAHYpf_c -m gemini-3.1-flash-lite --tts gemini-3.1-flash-tts-preview-Kore --infographic gemini-3.1-flash-image-preview --combine-infographic-audio
```
...
```bash
youtube-to-docs atmGAHYpf_c -m gemini-3.1-flash-lite -tr gemini-3.1-flash-lite-es --tts gemini-3.1-flash-tts-preview-Kore --infographic gemini-3.1-flash-image-preview --combine-infographic-audio
```
